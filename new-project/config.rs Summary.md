...
**Purpose**: Central configuration for the Chunkr tool
**Key functionality**:
- Defines TOML configuration structures (logging, paths, extraction, chunking, insertion)
- Provides default values for all configuration parameters
- Loads config files via `load()` function
**Critical components**:
